...
print("\n-------------------------------------------")
print("Testing 10 instances to visualization")
...
print('acuracia:',np.mean(test_log))
...
print("\n-------------------------------------------")
print("Testing with 10000 instances and show accuracy")
# In[92]:
...
print('accurancy:',np.mean(test_log))
